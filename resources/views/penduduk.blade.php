                                    ...
                                    <tbody>
                                        @forelse ($data as $prediction)
                                            ...
                                            <tr>
                                                <td>
                                                    @if ($prediction->penduduk->pas_foto)
                                                        <img src="{{ asset('storage/pas_foto/' . $prediction->penduduk->pas_foto) }}"
                                                            alt="Pas Foto" style="width: 100px;">
                                                    @else
                                                        Tidak Ada Foto
                                                    @endif
                                                </td>
                                                <td>
                                                    <h6 class="mb-0 text-sm">{{ $prediction->penduduk->NIK }}</h6>
                                                </td>
                                                <td>
                                                    <h6 class="mb-0 text-sm">{{ $prediction->penduduk->Nama_lengkap }}
                                                    </h6>
                                                </td>
                                                <td>
                                                    {{-- Pakai image --}}
                                                ...
                                                <td>
                                                    <h6 class="mb-0 text-sm">{{ $prediction->keterangan }}</h6>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
