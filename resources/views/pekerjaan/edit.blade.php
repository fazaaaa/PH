                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form role="form" class="form-group mx-10 my-6"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" id="Pekerjaan" name="id_penduduk" class="form-control"
                                        placeholder="Pekerjaan" aria-label="Pekerjaan"
                                        value="{{ $pekerjaan->id_penduduk }}">
                                </div>

                                <label for="Penghasilan">Penghasilan</label>
                                <div class="mb-3">
                                    <input type="number" id="Penghasilan" name="pendapatan" class="form-control"
                                ...
                                <div class="mb-3">
                                    <input type="number" id="Penghasilan" name="jumlah" class="form-control"
                                        placeholder="Penghasilans" aria-label="Penghasilans"
                                ...
                                <div class="mb-3">
                                    <select id="id_penduduk" name="status" class="form-control"
                                        ...
                                        <option value="Bekerja"
                                            {{ $pekerjaan->status == 'Bekerja' ? 'selected' : '' }}>Bekerja</option>
                                        <option value="Tidak Bekerja"
                                            {{ $pekerjaan->status == 'Tidak Bekerja' ? 'selected' : '' }}>Tidak Bekerja
                                        </option>
                                    </select>
                                </div>
                                <div class="mb-3">
