...
<body class="antialiased min-h-screen bg-cover bg-center bg-no-repeat"
    style="background-image: url('{{ asset('bg.jpg') }}');background-repeat: no-repeat;background-size: cover;">
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex justify-center">
                ...
                <h4 class="text-white" style="color: white; font-size: 50px">Pembantu kelayakan rumah</h4>
                <br>
